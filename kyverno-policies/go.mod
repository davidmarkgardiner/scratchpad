module github.com/yourusername/kyverno-policies
...
require (
	...
	istio.io/api v1.24.0-alpha.0.0.20250108212904-6e7901d80e7d
...
// Add replace directives if needed for dependency compatibility
replace (
